    ...
    Scaffold(
        topBar = {
            LunchTrayAppBar(
                ...
                canNavigateBack = currentScreen.title != LunchTrayScreen.Start.title,
        ...
        NavHost(
            ...
            composable(route = LunchTrayScreen.EntreeMenu.name) {
                EntreeMenuScreen(
                    ...
                    onCancelButtonClicked = { cancelAndResetStore() },
                    onNextButtonClicked = {
            ...
            composable(route = LunchTrayScreen.Checkout.name) {
                CheckoutScreen(
                    ...
                    onNextButtonClicked = { cancelAndResetStore() },
                    onCancelButtonClicked = { cancelAndResetStore() })
            }
        }
    }
