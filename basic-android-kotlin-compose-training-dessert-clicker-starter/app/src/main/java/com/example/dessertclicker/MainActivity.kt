    ...
    Scaffold(
        ...
        DessertClickerScreen(
            ...
            onDessertClicked = {
                ...
                // Update the revenue
                dessertViewModel.sumRevenuePrice(dessertUiState.currentDessertPrice)
                dessertViewModel.sumDessertSold()

                // Show the next dessert
                val dessertToShow = determineDessertToShow(desserts, dessertUiState.dessertsSold)
                dessertViewModel.updateCurrentDessertAndPrice(
                    imageID = dessertToShow.imageId,
                    priceId = dessertToShow.price
                )
            },
